...
- A practical conclusion
    ...
    Since we **reject the null hypothesis** from the Likelihood Ratio Test Statistics, hence class played a significant role in surviving on the Titanic
...
- The test statistic of the test
    ...
    The logistic regression summary, we can see the significance of the interaction between age and sex
