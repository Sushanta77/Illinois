...
for(s in 1:length(sigma)){
  ...
  print (paste("Sigma:",sigma[s]," F Statistics:",anova(null_model,full_model)$F[2],"P Value:",anova(null_model,full_model)$'Pr(>F)'[2], "R Squared:",summary(full_model)$r.squared))
}
...
Below is the simulation for 2500 simulations
```{r}
model_significance = cbind(sigma_1_P=rep(0,no_loop),sigma_1_F=rep(0,no_loop),sigma_1_R_SQUARED=rep(0,no_loop),
                           sigma_5_P=rep(0,no_loop),sigma_5_F=rep(0,no_loop),sigma_5_R_SQUARED=rep(0,no_loop),
                           sigma_10_P=rep(0,no_loop),sigma_10_F=rep(0,no_loop),sigma_10_R_SQUARED=rep(0,no_loop))
extra_counter = 0
