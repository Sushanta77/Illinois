---
title: "Forced Expiratory Volume (FEV) prediction for Childhood Respiratory Disease"
author: "Luma Vasiljevic, Sushanta Panda"
date: "7/20/2019"
...
```{r echo=FALSE}
library(knitr)
kable(TeamName, format = "pandoc",padding = 2,caption = "Team Name - STAT 420 - Data Analysis Project")
```
...
**Below are the all variables in the dataset**
...
```{r echo=FALSE}
library(knitr)
kable(Variable, format = "pandoc",padding = 2,caption = "Team Name - STAT 420 - Data Analysis Project")
```
