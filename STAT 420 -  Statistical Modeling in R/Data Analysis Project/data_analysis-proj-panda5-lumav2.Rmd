...
```{r}
poly2_model = lm(FEV ~ Sex + Smoker + poly(Age,2) + poly(Height,2), data = childfev)
poly3_model = lm(FEV ~ Sex + Smoker + poly(Age,3) + poly(Height,3), data = childfev)
poly4_model = lm(FEV ~ Sex + Smoker + poly(Age,4) + poly(Height,4), data = childfev)
poly5_model = lm(FEV ~ Sex + Smoker + poly(Age,5) + poly(Height,5), data = childfev)
poly6_model = lm(FEV ~ Sex + Smoker + poly(Age,6) + poly(Height,6), data = childfev)
```
...
plot(polynomial_degree, r2_model, type = "b",
       ylim = c(min(r2_model), max(r2_model)), col = purple, lwd = 2,
       xlab = "Polynomial Degree", ylab = "R2", main = "RSS Vs Polynomial Degree")

plot(polynomial_degree, adjr2_model, type = "b",
       ylim = c(min(adjr2_model), max(adjr2_model)), col = green, lwd = 2,
...
plot(polynomial_degree, train_test_error_model, type = "b",
       ylim = c(min(train_test_error_model), max(train_test_error_model)), col = blue, lwd = 2,
