...
```{r include=FALSE}
train_test_error_model = rep(0,5)
r2_model = rep(0,5)
adjr2_model = rep(0,5)
...
train_test_error_model[1] = average_percent_error(childfev_tst_data$FEV, predict(mlr_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))
train_test_error_model[2] = average_percent_error(childfev_tst_data$FEV, predict(poly2_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))
train_test_error_model[3] = average_percent_error(childfev_tst_data$FEV, predict(poly3_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))
train_test_error_model[4] = average_percent_error(childfev_tst_data$FEV, predict(poly4_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))
train_test_error_model[5] = average_percent_error(childfev_tst_data$FEV, predict(poly5_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))
train_test_error_model[6] = average_percent_error(childfev_tst_data$FEV, predict(poly6_model, childfev_tst_data[c("Age","Height","Sex","Smoker")]))


#R2
r2_model[1] = summary(mlr_model)$r.squared
r2_model[2] = summary(poly2_model)$r.squared
r2_model[3] = summary(poly3_model)$r.squared
r2_model[4] = summary(poly4_model)$r.squared
r2_model[5] = summary(poly5_model)$r.squared
r2_model[6] = summary(poly6_model)$r.squared

#Adjusted R2
adjr2_model[1] = summary(mlr_model)$adj.r.squared
adjr2_model[2] = summary(poly2_model)$adj.r.squared
adjr2_model[3] = summary(poly3_model)$adj.r.squared
adjr2_model[4] = summary(poly4_model)$adj.r.squared
adjr2_model[5] = summary(poly5_model)$adj.r.squared
adjr2_model[6] = summary(poly6_model)$adj.r.squared
```
...
rss_model = rep(0,5)
rmse_model = rep(0,5)
rmse_loocv_model = rep(0,5)

#Populate RSS
rss_model[1] = sum((resid(mlr_model))^2)
rss_model[2] = sum((resid(poly2_model))^2)
rss_model[3] = sum((resid(poly3_model))^2)
rss_model[4] = sum((resid(poly4_model))^2)
rss_model[5] = sum((resid(poly5_model))^2)
rss_model[6] = sum((resid(poly6_model))^2)

#Populate RMSE
rmse_model[1] = sqrt(mean(sum((resid(mlr_model))^2)))
rmse_model[2] = sqrt(mean(sum((resid(poly2_model))^2)))
rmse_model[3] = sqrt(mean(sum((resid(poly3_model))^2)))
rmse_model[4] = sqrt(mean(sum((resid(poly4_model))^2)))
rmse_model[5] = sqrt(mean(sum((resid(poly5_model))^2)))
rmse_model[6] = sqrt(mean(sum((resid(poly6_model))^2)))

#Populate RMSE LOOC
rmse_loocv_model[1] = sqrt(mean((resid(mlr_model)/(1-hatvalues(mlr_model)))^2))
rmse_loocv_model[2] = sqrt(mean((resid(poly2_model)/(1-hatvalues(poly2_model)))^2))
rmse_loocv_model[3] = sqrt(mean((resid(poly3_model)/(1-hatvalues(poly3_model)))^2))
rmse_loocv_model[4] = sqrt(mean((resid(poly4_model)/(1-hatvalues(poly4_model)))^2))
rmse_loocv_model[5] = sqrt(mean((resid(poly5_model)/(1-hatvalues(poly4_model)))^2))
rmse_loocv_model[6] = sqrt(mean((resid(poly6_model)/(1-hatvalues(poly6_model)))^2))
```
...
plot(polynomial_degree, rss_model, type = "b",
       ylim = c(min(rss_model), max(rss_model)), col = purple, lwd = 2,
       xlab = "Polynomial Degree", ylab = "Residual Sum Square (RSS)", main = "RSS Vs Polynomial Degree")

plot(polynomial_degree, rmse_model, type = "b",
       ylim = c(min(rmse_model), max(rmse_model)), col = green, lwd = 2,
       xlab = "Polynomial Degree", ylab = "Root Mean Square (RMSE)", main = "RMSE Vs Polynomial Degree")

plot(polynomial_degree, rmse_loocv_model, type = "b",
       ylim = c(min(rmse_loocv_model), max(rmse_loocv_model)), col = blue, lwd = 2,
...
par(mfrow = c(1, 3), oma = c(0, 0, 5, 0))
polynomial_degree = 1:6
plot(polynomial_degree, r2_model, type = "b",
       ylim = c(min(r2_model), max(r2_model)), col = gold, lwd = 2,
       xlab = "Polynomial Degree", ylab = "R2", main = "RSS Vs Polynomial Degree")

plot(polynomial_degree, adjr2_model, type = "b",
       ylim = c(min(adjr2_model), max(adjr2_model)), col = red, lwd = 2,
       xlab = "Polynomial Degree", ylab = "Adjusted R2", main = "Adjusted R2 Vs Polynomial Degree")

plot(polynomial_degree, train_test_error_model, type = "b",
       ylim = c(min(train_test_error_model), max(train_test_error_model)), col = orchid, lwd = 2,
...
#####**Anova F Test**
```{r echo=FALSE}
anova_p_value = rep(0,4)
anova_p_value[1] = anova(mlr_model,poly2_model)$'Pr(>F)'[2]
anova_p_value[2] = anova(poly2_model,poly3_model)$'Pr(>F)'[2]
anova_p_value[3] = anova(poly2_model,poly4_model)$'Pr(>F)'[2]
anova_p_value[4] = anova(poly2_model,poly5_model)$'Pr(>F)'[2]
anova_p_value[5] = anova(poly2_model,poly6_model)$'Pr(>F)'[2]

red = "firebrick4"

par(mfrow = c(1, 3), oma = c(0, 0, 5, 0))
polynomial_degree = 1:5
plot(polynomial_degree, anova_p_value, type = "b",
       ylim = c(min(anova_p_value), max(anova_p_value)), col = red, lwd = 2,
...
```{r}
model_age = lm(FEV ~ Age , data = childfev)
model_age_sex = lm(FEV ~ (Age + Sex) ^ 2 , data = childfev)
model_age_smoker = lm(FEV ~ (Age + Smoker) ^ 2 , data = childfev)
model_height = lm(FEV ~ Height , data = childfev)
model_height_sex = lm(FEV ~ (Height + Sex) ^ 2 , data = childfev)
model_height_smoker = lm(FEV ~ (Height + Smoker) ^ 2 , data = childfev)
model_age_height = lm(FEV ~ (Age + Height) ^ 2 , data = childfev)
model_all = lm(FEV ~ Age + Height + Sex + Smoker + Age:Sex + Age:Smoker + Height:Sex + Height:Smoker, data = childfev) 
