...
###Model - Multiple Linear Regression (MLR) FEV data:
...
###Model - Transformation of response variable FEV (Logarithimic):
...
###Model - Transformation of Predictor Variable FEV
...
###Model - Interaction between Predictors:
...
###Model- Creation of Big Model (Polynomial + Interaction), Stepwise via AIC / BIC:
